...
export interface HarnessAdapter {
  ...
  history(sessionId: string): Promise<HarnessEvent[]>; rawHistory(sessionId: string): Promise<Record<string, unknown>[]>; sendMessage(sessionId: string, message: string, context: AgentContext): Promise<void>
